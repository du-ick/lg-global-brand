                ...
                <li class="c-header__gnb__list__item"><a href="javascript:void(0)"  onmouseenter="initGnbDeps2(this); return false" onclick="initGnbDeps2(this);  return false" class="c-header__gnb__list__item__anchor c-header__gnb__list__item__anchor--active">Elements</a>
                    <div class="c-header__gnb__list__item__deps2">
                        <ul class="c-header__gnb__list__item__deps2__menu">
                            <li class="c-header__gnb__list__item__deps2__menu__item"><a href="/global/our-brand/brand-visualization/logo/index.jsp" class="c-header__gnb__list__item__deps2__menu__item__anchor c-header__gnb__list__item__deps2__menu__item__anchor--active">Logo</a></li>
                            <li class="c-header__gnb__list__item__deps2__menu__item"><a href="/global/our-brand/brand-visualization/color/index.jsp" class="c-header__gnb__list__item__deps2__menu__item__anchor">Color &amp; Gradients</a></li>
                            <li class="c-header__gnb__list__item__deps2__menu__item"><a href="/global/our-brand/brand-visualization/slogan/index.jsp" class="c-header__gnb__list__item__deps2__menu__item__anchor">Slogan</a></li>
                            <li class="c-header__gnb__list__item__deps2__menu__item"><a href="/global/our-brand/brand-visualization/photography/index.jsp" class="c-header__gnb__list__item__deps2__menu__item__anchor">Photography</a></li>
                            <li class="c-header__gnb__list__item__deps2__menu__item"><a href="/global/our-brand/brand-visualization/design-system/index.jsp" class="c-header__gnb__list__item__deps2__menu__item__anchor">Design System</a></li>
                            <li class="c-header__gnb__list__item__deps2__menu__item"><a href="/global/our-brand/brand-visualization/typography/index.jsp" class="c-header__gnb__list__item__deps2__menu__item__anchor">Typography</a></li>
                            <li class="c-header__gnb__list__item__deps2__menu__item"><a href="/global/our-brand/brand-visualization/voice/index.jsp" class="c-header__gnb__list__item__deps2__menu__item__anchor">Voice</a></li>
                        </ul>
