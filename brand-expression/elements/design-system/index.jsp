						...
						<div class="tab-container" data-tab="lens">
							<div id="intelligent" class="tab-container__content tab-container__content--active">
								<div class="design-system__imagebox design-system__imagebox--intelligent percent-view">
									<video muted playsinline autoplay loop class="percent-view__img video-only-pc" >
										<source src="/global/our-brand/brand-expression/img/elements/design-system/the_ei_lens_circle_intelligent_d.mp4" type="video/mp4">
									</video>
									<video muted playsinline autoplay loop class="percent-view__img video-only-mo">
										<source src="/global/our-brand/brand-expression/img/elements/design-system/the_ei_lens_circle_intelligent_m.mp4" type="video/mp4">
									</video>
								</div>
							</div>
							<div id="respectful" class="tab-container__content">
								<div class="design-system__imagebox design-system__imagebox--respectful percent-view">
									<video muted playsinline autoplay loop class="percent-view__img video-only-pc" >
										<source src="/global/our-brand/brand-expression/img/elements/design-system/the_ei_lens_square_respectful_d.mp4" type="video/mp4">
									</video>
									<video muted playsinline autoplay loop class="percent-view__img video-only-mo">
										<source src="/global/our-brand/brand-expression/img/elements/design-system/the_ei_lens_square_respectful_m.mp4" type="video/mp4">
									</video>
								</div>
							</div>
						</div>
