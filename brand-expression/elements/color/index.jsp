...
<head>
	...
	<title>LG Brand expression | Color & gradients</title>
	<meta name="description" content="At our core, LG has always been a red brand. That is still true today. However, we’ve built outwards from our core to give our identity flex. Incorporating ‘Active Red’ and neutral colors so we can create excitement and restore balance when we need to." />
	<meta name="keywords" content="LG, expression, logo, brand" />
	<meta property="og:locale" content="en_GLOBAL" />
	<meta property="og:site_name" content="LG Brand expression | Color & gradients" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="LG Brand expression | Color & gradients" />
	<meta property="og:url" content="" />
	<meta property="og:description" content="At our core, LG has always been a red brand. That is still true today. However, we’ve built outwards from our core to give our identity flex. Incorporating ‘Active Red’ and neutral colors so we can create excitement and restore balance when we need to." />
	...
	<div class="brand-contents">
		<div id="container">
            ...
            <!-- CONTENTS -->
				...
				<link rel="stylesheet" href="/global/our-brand/brand-expression/css/colors.css" />
                    ...
                    <div id="visual-colors" class="visual__top">
                        ...
                        <div class="visual-innner">
                            <div class="download_assets">
                                <img src="/global/our-brand/brand-expression/img/elements/color/download_assets_gradients.png" alt class="download_assets__thumb"></img>
                                <p class="download_assets__title">
                                    <b>LG gradients</b>
                                    Download Assets
                                </p>
                                <a class="download_assets__btn" href="/global/our-brand/brand-expression/downloads/lge-core-brand-assets-gradients.zip" download></a>
                            </div>
                        </div>
                    </div>
                    <div class="brand__content-inner">
                        ...
                        <div class="brand-colors__grid">
                            ...
                            <div class="brand-colors__item brand-colors__item--heritage-red">
                                ...
                                <a class="btn-copy-hexcode" href="#A50034">Copy hex code</a>
                            </div>
                            <div class="brand-colors__item brand-colors__item--warmgray">
                                ...
                                <a class="btn-copy-hexcode btn-copy-hexcode--dark" href="#F0ECE4">Copy hex code</a>
                            </div>
                            <div class="brand-colors__item brand-colors__item--white">
                                ...
                                <a class="btn-copy-hexcode btn-copy-hexcode--dark" href="#FFFFFF">Copy hex code</a>
                            </div>
                            <div class="brand-colors__item brand-colors__item--black">
                                ...
                                <a class="btn-copy-hexcode" href="#000000">Copy hex code</a>
                            </div>
                        </div>
                        <div class="brand__header">
				...
				<script src="/global/our-brand/brand-expression/js/colors.js"></script>
            <!-- /CONTENTS -->
            <!-- footer -->
